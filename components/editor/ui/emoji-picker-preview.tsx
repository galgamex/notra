...
export type PickAnEmojiPreviewProps = Pick<UseEmojiPickerType, 'i18n'>;

function EmojiPreview({ emoji }: Readonly<EmojiPreviewProps>) {
	return (
...
function NoEmoji({ i18n }: Readonly<NoEmojiPreviewProps>) {
	return (
		<div className="flex h-14 max-h-14 min-h-14 items-center border-t border-muted p-2">
...
function PickAnEmoji({ i18n }: Readonly<PickAnEmojiPreviewProps>) {
	return (
		<div className="flex h-14 max-h-14 min-h-14 items-center border-t border-muted p-2">
...
export function EmojiPickerPreview({
	...
	isSearching = false,
	...props
}: Readonly<EmojiPickerPreviewProps>) {
